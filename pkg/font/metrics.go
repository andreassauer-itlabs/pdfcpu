...
import (
	...
	"github.com/andreassauer-itlabs/pdfcpu/internal/corefont/metrics"
...
func (fd TTFLight) unicodeRangeBits(id string) []int {
	...
	// Please go to https://github.com/andreassauer-itlabs/pdfcpu/issues/new/choose for an extension request.
	//
