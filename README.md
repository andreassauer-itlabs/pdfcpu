...
[![Test](https://github.com/andreassauer-itlabs/pdfcpu/workflows/Test/badge.svg)](https://github.com/andreassauer-itlabs/pdfcpu/actions)
...
[![GoDoc](https://godoc.org/github.com/andreassauer-itlabs/pdfcpu?status.svg)](https://pkg.go.dev/github.com/andreassauer-itlabs/pdfcpu)
[![Go Report Card](https://goreportcard.com/badge/github.com/andreassauer-itlabs/pdfcpu)](https://goreportcard.com/report/github.com/andreassauer-itlabs/pdfcpu)
...
[![Latest release](https://img.shields.io/github/release/pdfcpu/pdfcpu.svg)](https://github.com/andreassauer-itlabs/pdfcpu/releases)
...
- [API tests](https://github.com/andreassauer-itlabs/pdfcpu/tree/master/pkg/api/test)
- [API samples](https://github.com/andreassauer-itlabs/pdfcpu/tree/master/pkg/samples)
- CLI usage: `$ pdfcpu help cmd`

### GoDoc

- [pdfcpu package](https://pkg.go.dev/github.com/andreassauer-itlabs/pdfcpu)
- [pdfcpu API](https://pkg.go.dev/github.com/andreassauer-itlabs/pdfcpu/pkg/api)
- [pdfcpu CLI](https://pkg.go.dev/github.com/andreassauer-itlabs/pdfcpu/pkg/cli)
...
Get the latest binary [here](https://github.com/andreassauer-itlabs/pdfcpu/releases).

### Using Go Modules

```
$ git clone https://github.com/andreassauer-itlabs/pdfcpu
...
```
$ go install github.com/andreassauer-itlabs/pdfcpu/cmd/pdfcpu@latest
```
...
- Please [create](https://github.com/andreassauer-itlabs/pdfcpu/issues/new/choose) an issue if you find a bug or want to propose a change.
- Feature requests - always welcome!
- Bug fixes - always welcome!
- PRs - let's [discuss](https://github.com/andreassauer-itlabs/pdfcpu/discussions) first or [create](https://github.com/andreassauer-itlabs/pdfcpu/issues/new/choose) an issue.
- pdfcpu is stable but still _Alpha_ and occasionally undergoing heavy changes.

### How

- The pdfcpu [discussion board](https://github.com/andreassauer-itlabs/pdfcpu/discussions) is open! Please engage in any form helpful for the community.
